...
class table_widget(QTableWidget):
    ...
    def update_table(self, bundles, search):
        ...
        for i in range(len(bundles)):
            ...
            converted_time = datetime.fromtimestamp(bundles[i]["LastModified"]) # convert unix seconds to time and date
            update = QTableWidgetItem(converted_time.strftime('%x %X'))# print date and time based on system locale
